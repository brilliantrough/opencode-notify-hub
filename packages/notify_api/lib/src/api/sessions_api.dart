...
class SessionsApi {
  ...
  /// Upgrade a temporary WebUI tunnel.
  /// The client sends one webui_tunnel_open frame naming an online instance, then proxies HTTP and SSE requests through the authenticated tunnel. The tunnel is memory-only and ends when either WebSocket closes.
  ///
  /// Parameters:
