...
class AuthApi {
  ...
  Future<Response<void>> forgotPassword({
    ...
    try {
      const _type = FullType(EmailBody);
      _bodyData = _serializers.serialize(emailBody, specifiedType: _type);
  ...
  /// Every refresh rotates the refresh token. Presenting an already rotated token revokes the whole token family (REFRESH_REUSED).
  ///
  /// Parameters:
  /// * [refreshBody]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> resendVerification({
    required EmailBody emailBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/auth/resend-verification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  /// Reset the password with the SMTP-delivered code.
  /// A successful reset revokes every refresh-token family of the user.
  ///
  /// Parameters:
  /// * [resetPasswordBody]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Verify an email address with the SMTP-delivered code.
  ///
  ///
  /// Parameters:
  /// * [verifyEmailBody]
  ...
  Future<Response<void>> verifyEmail({
    required VerifyEmailBody verifyEmailBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/auth/verify-email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      const _type = FullType(VerifyEmailBody);
      _bodyData = _serializers.serialize(verifyEmailBody, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
